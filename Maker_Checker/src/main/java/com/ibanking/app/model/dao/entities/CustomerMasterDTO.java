...
//lombok annotation
@Entity       // treat below class as a database table
@Getter
@Setter
@EqualsAndHashCode
@ToString
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "customer_master_table_16787")
public class CustomerMasterDTO {
    ...
    @Id
    @NotNull
    @Column(unique = true, length = 10, name = "customer_code")
    ...
    public CustomerMasterDTO(String customerCode, String customerName, String address1,
